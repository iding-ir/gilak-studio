...
export const drawQuadrants = (ctx: CanvasRenderingContext2D, w: number, h: number) => {
  const midX = w / 2
  const midY = h / 2
...
export const drawGradient = (ctx: CanvasRenderingContext2D, w: number, h: number) => {
...
export const drawCircles = (ctx: CanvasRenderingContext2D, w: number, h: number) => {
  ctx.fillStyle = randomColor()
  ctx.fillRect(0, 0, w, h)
...
export const drawWaves = (ctx: CanvasRenderingContext2D, w: number, h: number) => {
...
export const drawCheckerboard = (ctx: CanvasRenderingContext2D, w: number, h: number) => {
